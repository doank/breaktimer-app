...
export default function ScheduleForm(props: Props): JSX.Element {
  ...
  const schedules: Schedule[] = typeof props.settingsDraft[settingsPath + 'Schedules' as keyof Settings] != 'undefined' ? props.settingsDraft[settingsPath + 'Schedules' as keyof Settings] as Schedule[] : [];
